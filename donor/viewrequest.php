...
-->
            <div style="height:1700px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
                    ...
                    <div cellpadding="0" cellspacing="0" width="450px" align="center">
                        ...
                        try{
                            ...
                            foreach($table as $data){
                                if($data[12]==$_SESSION['email'] ||$data[13]==$_SESSION['email']){
                                    $count=$count+1;
                                }
                            }
                        }catch(PDOException $ex){
                        ...
                        <?php
                            ...
                            foreach($table as $data){
                                //                            $f=1;
                                if(($data[12]==$_SESSION['email'] || $data[13]==$_SESSION['email']) && $data[11]==1){
                                    //                                echo $f;
                                    //                                echo $em1;
                                    //                                $f=0;
                                    //                                echo $f;
                        ...
                        <div align="center" style="height:200px;width:500px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
                            ...
                            <div align="center">Resposed by:
                                <?php 
                            $sqlr="SELECT name from donarregistration WHERE email='$data[12]'";
                            ...
                            $sqlr1="SELECT name from donarregistration WHERE email='$data[13]'";
                        ...
                        <?php
                                ...
                                else if(($data[11]==0 && $em1==0)||($data[9]<=0 && $data[11]==1)|| $count==1 ){
                                    //                                echo $f;
                                    //                                echo $em1;
                                    //                                $f=1;
                                    //                                echo $f;
                        ...
                        <?php
                                ...
                                else if(($data[11]==0 &&($data[12]=="") && $em1==1)){
                                    //                                echo $f;
                                    //                                echo $em1;
                                    //                                                                    $f=1;
                                    //                                echo $f;
                        ...
                        <div align="center" style="height:200px;width:500px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
                            ...
                            <?php
                                ...
                                else if(($data[11]==1 &&($data[12]!="") && $data[9]>=1)){
                                    //                                echo $f;
                                    //                                echo $em1;
                                    //                                                                    $f=1;
                                    //                                echo $f;
