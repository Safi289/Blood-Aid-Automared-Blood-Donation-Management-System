...
if(isset($_POST["sbmt"])) 
{
	...
	$cn=makeconnection();
		$d=$_POST["year"]."/".$_POST["month"]."/".$_POST["day"];
			$s="insert into requestes(name,gender,age,mobile,email,bg_name,reqdate,detail,quan,Address) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t5"] . "','" . $_POST["bl"] . "','" . $d .  "','" .  $_POST["t7"]  ."','" .  $_POST["t10"]  ."','" .  $_POST["t11"]  ."')";
